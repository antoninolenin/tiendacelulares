                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="text-center">
                                ...
                                ?>
      <a href="report/factura.php?id=<?php echo $idPedido; ?>&tipo=pdf" target="_blank" class="btn btn-primary btn-sm" style="margin-right: 5px;">
    <i class="fa fa-file-pdf-o"></i> Imprimir Factura (PDF)
</a>
<a href="report/factura.php?id=<?php echo $idPedido; ?>&tipo=html" target="_blank" class="btn btn-info btn-sm">
    <i class="fa fa-file-text-o"></i> Imprimir Factura (HTML)
</a>
                            </td>
                            <td class="text-center">
