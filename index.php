            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:5%;">
                        <p><i class="fa fa-users fa-4x"></i></p> <h3>Registrate</h3>
                        <p>Registrate como cliente de <span class="tittles-pages-logo">luxe cell</span> en un sencillo formulario para poder completar tus pedidos</p>
                ...
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/celulares.webp" alt="Smart-TV" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
